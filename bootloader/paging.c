...
// void inline map_address(void* virtual_address, void* physical_address) {
// 	// Indexes
...
// 	page_map_level* pdp;
// 	if (!pde.present) {
// 		BS->AllocatePages(AllocateAnyPages, EfiLoaderData, 1, (uint64_t*)&(pdp));
// 		check();
// 		memset(pdp, 0, 0x1000);
...
// 	page_map_level* pd;
// 	if (!pde.present) {
// 		BS->AllocatePages(AllocateAnyPages, EfiLoaderData, 1, (uint64_t*)&(pd));
// 		check();
// 		memset(pd, 0, 0x1000);
...
// 	page_map_level* pt;
// 	if (!pde.present) {
// 		BS->AllocatePages(AllocateAnyPages, EfiLoaderData, 1, (uint64_t*)&(pt));
// 		check();
// 		memset(pt, 0, 0x1000);
